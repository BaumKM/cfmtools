...
from tests.data.target.fm_helpers import ZERO, FMGroupType, configure_feature

CTC_4_PATH = TEST_MODEL_PATH / "uvl/fm/valid/ctc_4.uvl"
...
def ctc_4_cfm() -> CFM:
    ...
    # !A => !B
    b.add_require_constraint("A", ZERO, ZERO, "B")
