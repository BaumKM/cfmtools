...
@sampler("backtracking", spaces={"structural"})
class BacktrackingSampler(SampleAlgorithm):
    """
    Uniform backtracking sampler (Rust backend).
    """
    ...
    def run_benchmark(
        ...
        *,
        ...
        result = structural.benchmark_backtracking_sampler(
            runs=runs,
            samples=samples,
            seed=seed,
